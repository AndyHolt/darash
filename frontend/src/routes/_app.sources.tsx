  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
      ...
      <section className="space-y-2">
        <h2 className="font-semibold">Morphology and tagging</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold">Underlying Greek text edition</h2>
        <p>The Greek text is the SBL Greek New Testament (SBLGNT), edited by Michael W. Holmes.</p>
        <Attribution
          title={
      ...
      <section className="space-y-2">
        <h2 className="font-semibold">Glosses and definitions</h2>
        <p>
          Glosses and definitions are from TBESG (Translators Brief lexicon of Extended Strongs for
          Greek), part of the{" "}
          <a
      ...
      <section className="space-y-2">
        <h2 className="font-semibold">Additional alignment</h2>
